			...
			<div class="container">
				...
				<div class="user__details">
					...
					<div class="input__box">
						...
						<h:inputText id="firstName" value="#{editPatient.firstname}" />
						<h:outputText value="#{FirstError1}" style="color:red"/>
					...
					<div class="input__box">
						...
						<h:inputText id="userName" value="#{editPatient.username}" />
						<h:outputText value="#{FirstError2}" style="color:red"></h:outputText>
					</div>
					<div class="input__box">
						<span class="details">Email</span>
						<h:inputText id="email" value="#{editPatient.email}" />
						<h:outputText  value="#{FirstError4}" style="color:red"></h:outputText>
					    <h:outputText value="#{FirstError5}" style="color:red"></h:outputText>
					</div>
					<div class="input__box">
					...
					<div class="input__box">
						...
						<h:inputText id="address" value="#{editPatient.address}" />
						<h:outputText value="#{FirstError6}" style="color:red"></h:outputText>
					</div>
				...
				<div class="gender__details">
					...
					<h:outputText value="#{FirstError9}" style="color:red"></h:outputText>
